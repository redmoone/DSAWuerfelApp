...
builder.Services.AddSingleton<HeroTalentIndexBuilder>();
builder.Services.AddSingleton<HeroSpellIndexBuilder>();
builder.Services.AddSingleton<ProbeSearchEntryFactory>();
builder.Services.AddSingleton<HeroProbeCatalogBuilder>();
builder.Services.AddSingleton<SpellOptionAvailabilityService>();
builder.Services.AddSingleton<SpellSelectionResolver>();
builder.Services.AddSingleton<SpellSelectionPanelFactory>();
builder.Services.AddSingleton<SpellInfoSectionFactory>();
builder.Services.AddSingleton<SpellOptionResolver>();
builder.Services.AddSingleton<ProbeResolutionService>();
builder.Services.AddSingleton<DicePageContextFactory>();
builder.Services.AddSingleton<ProbeInfoService>();
